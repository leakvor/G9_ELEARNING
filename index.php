...
}else if(urlIs('/trainer') || urlIs('/trainerdashboard')|| urlIs('/displaylesson')|| urlIs('/formlessoncreate')|| urlIs('/formlessonedit')|| urlIs('/updatelesson') || urlIs("/createCourse") || urlIs("/updateCourse")){
