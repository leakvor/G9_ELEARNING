    ...
    <div class="container">
      ...
      <ul class="navbar-nav navbar-nav-scroll dropdown-clickable">
        <li class="nav-item dropdown dropdown-menu-shadow-stacked">
          ...
          <ul class="dropdown-menu z-index-unset" aria-labelledby="categoryMenu">
            ...
            <li> <a class="dropdown-item bg-primary text-primary bg-opacity-10 rounded-2 mb-0" href="#">View all
                categories</a></li>
          </ul>
        </li>
      </ul>
          ...
          <div class="nav my-3 my-xl-0 px-4 flex-nowrap align-items-center">
            <div class="nav-item w-100">
              <form class="rounded position-relative">
                <input class="form-control pe-5 bg-secondary bg-opacity-10 border-0" id="search" type="search"
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end min-w-auto">
            <li> <a class="dropdown-item" href="<?= $path ?>"><i
                  class="fas fa-chalkboard-teacher fa-fw me-2"></i>Trainers</a></li>
      ...
      if (!isset($_SESSION['user'])) {
        ...
        <div class="navbar-nav d-none d-lg-inline-block">
          <a href="/signups" type="button" class="btn text-dark btn-dark-soft mb-0"><i
              class="fas fa-sign-in-alt me-2"></i>Sign Up</a>
          <a href="/signins" type="button" class="btn text-dark btn-dark-soft mb-0"><i
      ...
      if (isset($_SESSION['user'])) {
        ...
        <div class="nav-item dropdown">
          <a href="/studentDashboard" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
            <img class="rounded-circle me-lg-2" src="assets/images/profile/<?php echo $profileImg ?>" alt=""
          ...
          <div class="dropdown-menu dropdown-menu-end bg-dark border-0 rounded-0 rounded-bottom m-0">
            ...
            <li class="dropdown-submenu">
              ...
              <div class="card dropdown-menu d-flex align-items-center" style="width:330px" data-bs-popper="none">
                ...
                <a href="/studentDashboard"><img src="assets/images/profile/<?php echo $profileImg ?>" alt="Profile Image"
                    class="card-img-top profile-image mt-3 dropdown-item avatar-img rounded-circle me-lg-2"
                    style="width: 100px; height: 80px"></a>
                <h5 class="card-title dropdown-item text-center">
                  <?php echo $user['username'] ?>
                </h5>
                <p class="card-text dropdown-item text-center">
                  <?php echo $user['email'] ?>
                </p>
