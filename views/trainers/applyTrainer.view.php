					...
					<div class="row g-4 position-relative align-items-center justify-content-center">
						...
						<div class="col-sm-6 col-lg-3 text-center">
							<div class="d-flex justify-content-center">
								<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="89" data-purecounter-delay="200" data-purecounter-duration="0">89</h4>
						...
						<div class="col-sm-6 col-lg-3 text-center">
							<div class="d-flex justify-content-center">
								<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="25" data-purecounter-delay="200" data-purecounter-duration="0">25</h4>
								<span class="display-6 text-orange mb-0">K</span>
							</div>
						...
						<div class="col-sm-6 col-lg-3 text-center">
							<div class="d-flex justify-content-center">
								<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="180" data-purecounter-delay="200" data-purecounter-duration="0">180</h4>
								<span class="display-6 text-orange mb-0">K</span>
							</div>
						...
						<div class="col-sm-6 col-lg-3 text-center">
							<div class="d-flex justify-content-center">
								<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0" data-purecounter-end="20" data-purecounter-delay="200" data-purecounter-duration="0">20</h4>
				...
				<div class="row">
					...
					if(isset($_SESSION['validate'])){
					 ...
					 ?>
						<div class="card card-body shadow p-4">
							...
							<!-- Form START -->
							<form class="row g-3 mt-2 position-relative z-index-9" action="controllers/trainers/checkApplytrainer.controller.php" method="post" enctype="multipart/form-data">
									<input type="hidden" class="form-control" aria-label="First name" name="username" placeholder="Enter your name" value ="<?=$name?>"required>
									<input type="hidden" class="form-control" name="email" placeholder="Enter your email" value="<?=$email?>" required>		
									<input type="hidden" class="form-control" name="password" placeholder="Enter a password" value="<?=$password?>" required>
							
								<!-- Document for Apply -->
								<div class="col-12">
									<label class="form-label">Document for Apply *</label>
					...
					<div class="col-lg-7 z-index-9 mt-5 mt-xl-0">
						...
						<ul class="nav nav-pills nav-pill-soft my-4" id="course-pills-tab" role="tablist">
							...
							<!-- Tab item -->
							<li class="nav-item me-2 me-lg-4" role="presentation">
								<button class="nav-link mb-2 mb-xl-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-2" type="button" role="tab" aria-controls="course-pills-2" aria-selected="false" tabindex="-1">Instructor Role</button>
							</li>
							<!-- Tab item -->
							<li class="nav-item me-2 me-lg-4" role="presentation">
								<button class="nav-link mb-2 mb-xl-0" id="course-pills-tab-3" data-bs-toggle="pill" data-bs-target="#course-pills-3" type="button" role="tab" aria-controls="course-pills-3" aria-selected="false" tabindex="-1">Start with Course</button>
							</li>
						</ul>
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade active show" id="course-pills-1" role="tabpanel" aria-labelledby="course-pills-tab-1">
								...
								<p>You must fill all the information of yours:</p>
								<ul>
									<li>Please submit the document that make sure you're a real teacher​ :Certificate and Certificate of Pedagogy from the Ministry.</li>
								</ul>
							</div>
							...
							<div class="tab-pane fade" id="course-pills-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
								...
								<p>Large above be to means. Dashwood does provide stronger is. Warrant private blushes removed an in equally totally if. Delivered dejection necessary objection do Mr prevailed. Mr feeling does chiefly cordial in do. <img src="assets/images/element/instructor-course.svg" class="rounded float-start me-3 h-200px my-3" alt="..."> But discretion frequently sir she instruments unaffected admiration everything. Meant balls it if up doubt small purse. Required his you put the outlived answered position. A pleasure exertion if believed provided to. All led out world this music while asked. Paid mind even sons does he door no. Attended overcame repeated it is perceived Marianne in. I think on style child of. Servants moreover in sensible it ye possible. Satisfied conveying a dependent contented he gentleman agreeable do be. Water timed folly right aware if oh truth. Imprudence attachment him his for sympathize. Large above be to means. Dashwood does provide stronger is.
									<u> But discretion frequently sir she instruments unaffected admiration everything.</u> Meant balls it if up doubt small purse. Required his you put the outlived answered position. A pleasure exertion if believed provided to. All led out world this music while asked. Paid mind even sons does he door no.
								</p>
							</div>
						</div>
						<!-- Tab contents END -->
