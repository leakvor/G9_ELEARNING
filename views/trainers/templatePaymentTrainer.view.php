												...
												<form class="row text-start g-3">
													...
													<div class="col-md-6">
														<div class="choices" data-type="select-one" tabindex="0" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false">
															<div class="choices__inner"><select class="form-select form-select-sm js-choice border-0 choices__input" aria-label=".form-select-sm" hidden="" tabindex="-1" data-choice="active">
																	<option value="" data-custom-properties="[object Object]">Please choose one</option>
																</select>
																<div class="choices__list choices__list--single">
																	<div class="choices__item choices__placeholder choices__item--selectable" data-item="" data-id="1" data-value="" data-custom-properties="[object Object]" aria-selected="true">Please choose one</div>
																</div>
															</div>
															<div class="choices__list choices__list--dropdown" aria-expanded="false"><input type="search" name="search_terms" class="choices__input choices__input--cloned" autocomplete="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" aria-label="Please choose one" placeholder="">
																<div class="choices__list" role="listbox">
																	<div id="choices--5q59-item-choice-4" class="choices__item choices__item--choice is-selected choices__placeholder choices__item--selectable is-highlighted" role="option" data-choice="" data-id="4" data-value="" data-select-text="Press to select" data-choice-selectable="" aria-selected="true">Please choose one</div>
																	<div id="choices--5q59-item-choice-1" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="1" data-value="Bank of America" data-select-text="Press to select" data-choice-selectable="">Bank of America</div>
																	<div id="choices--5q59-item-choice-2" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="2" data-value="Bank of India" data-select-text="Press to select" data-choice-selectable="">Bank of India</div>
																	<div id="choices--5q59-item-choice-3" class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice="" data-id="3" data-value="Bank of London" data-select-text="Press to select" data-choice-selectable="">Bank of London</div>
																</div>
															</div>
														</div>
													</div>
					...
					<form class="row text-start g-3">
						...
						<div class="col-12">
							...
							<div class="position-relative">
								...
								<img src="assets/images/client/visa.svg" class="w-40px position-absolute top-50 end-0 translate-middle-y me-2" alt="">
							</div>
						</div>
						<!-- Expiration Date -->
						<div class="col-md-6">
