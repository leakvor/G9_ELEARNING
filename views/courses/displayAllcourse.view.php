...
Page content START -->
		<section class="pt-5">
			<div class="container">
					...
					<div class="col-sm-6 col-xl-4">
						<form class="border rounded p-2">
							<div class="input-group input-borderless">
								<input class="form-control me-1" type="search" placeholder="Search course" id="search">
				...
				<!-- Course list START -->
				<div class="row g-4 justify-content-center" id="courses">
					<?php
										...
										<div class="col-md-8">
											<div class="card-body">
												...
												<div class="d-flex justify-content-between mb-2">
													<h5 class="card-title mb-0" id="title"><a href="#"><?= $displayCourse['title'] ?></a></h5>
													<!-- Wishlist icon -->
