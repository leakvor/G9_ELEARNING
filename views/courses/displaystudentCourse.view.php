<body>
    ...
    <main>
        ...
        if (isset($_SESSION['user'])) {
            $user = $_SESSION['user'];
            $id = $user['user_id'];
            $allMycourse = myCourse($id);
            $courseLessonCount=countLesson();
            ...
            <div class="container">
                <div class="row mt-3">
                    ...
                    <div class="col-12">
                        <!-- Course Grid START -->
                        <div class="row g-4">
                            <?php foreach($allMycourse as $myCourse): ?>
                                 <!-- Card item START -->
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        <!-- Title -->
                                        <h5 class="card-title"><a href="#"><?=$myCourse['title']?></a></h5>
                                        <!-- Rating star -->
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i><?= isset($courseLessonCount[$myCourse['course_id']]) ? ($courseLessonCount[$myCourse['course_id']] < 2 ? $courseLessonCount[$myCourse['course_id']] . " lesson" : $courseLessonCount[$myCourse['course_id']] . " lessons") : 0 . " lesson" ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
