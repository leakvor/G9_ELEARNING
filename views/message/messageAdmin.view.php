        ...
        <section class="pt-5 pb-0" style="background-image:url(assets/images/element/map.svg); background-position: center left; background-size: cover;">
            <div class="container">
                <div class="row" style="margin-top: 50px;">
                    <div class="col-lg-8 col-xl-6 text-center mx-auto" style="margin-top: 30px;">
                        <!-- Title -->
                ...
                <div class="row g-4 g-lg-0 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <form>
                            ...
                            <div class="d-grid">
                                <a href="/adminTrainer" class="alert-link">
                                    <button id="sendMessageBtn" class="btn btn-lg btn-primary mb-0" type="button">Send Message</button>
                                </a>
                            </div>
                            <script>
