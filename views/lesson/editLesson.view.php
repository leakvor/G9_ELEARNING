...
<section>
<div class="container">
    <h3 class="form-group text-success">Edit Lesson</h3>
    <form action="../../controllers/lesson/updatelesson.controller.php" method="post" enctype="multipart/form-data">
        <input type="hidden" value="<?= $lesson['lesson_id']?>" name="id">
        <div class="form-group">
            <label for="lessonName">Lesson Name</label>
            <input type="text" class="form-control mt-2 mb-2" name="lesson_title" id="lesson_title" value="<?=$lesson['lesson_title']?>" placeholder="Enter lesson name">
        </div>
        <div class="form-group">
